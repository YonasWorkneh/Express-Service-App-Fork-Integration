...
export default function InternationalPricingForm() {
  ...
  const handleSubmit = (
    ...
    console.log("International Pricing Data:", values);
    setSuccessMessage(
      "International pricing configuration saved successfully!"
    );
    ...
    <div className="max-w-4xl p-6 bg-white">
      ...
      >
        {({ values, setFieldValue, errors, touched }) => (
          <Form>
            <PricingFormHeader title="International Pricing Configuration" />
            ...
            <ServiceTypeSection
              ...
              onAddRange={() => {
                ...
                setFieldValue("standardWeightRanges", [
                  ...
                  {
                    from: lastRange.to,
                    to: String(Number(lastRange.to) + 10),
                    price: 0,
                  },
                ]);
              }}
